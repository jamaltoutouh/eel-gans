...
if len(sys.argv) < 3:
    ...
    print('Usage: python test_greedy_ensemble_generator.py <greedy mode> <ensemble size> [<output file>]')
...
dataset = 'mnist'
precision = 10
greedy = GreedyEnsembleGenerator(dataset, ensemble_max_size, precision, generators_prefix='mnist-generator',
                                 generators_path='./mnist-generators/', mode=mode, output_file=output_file)
